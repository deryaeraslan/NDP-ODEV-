...
namespace Nesneye_Dayalı_Ödev
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            textBox1.Text = asi.ToString(); //Aşı sayısını textboxa yazdır
            textBox2.Text = asiucret.ToString(); //Aşı ücretini textboxa yazdır

            if (asi == 6) //Sürekli aşı yaptırılması uygun olmayacağından aşı sayısı 6 ise
            {
                button1.Enabled = false; //Daha fazla aşı butonuna basama

            }
            if (asi > 0) //Aşı yapma butonuna 0'dan fazla basıldıysa 
            {
                button2.Enabled = true; //Butonu true döndür ve butona basabil
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            textBox1.Text = asi.ToString(); //Aşı yaptırmama sayısını textboxa yazdır
            textBox2.Text = asiucret.ToString(); //Aşı yaptırmadığı kadar ücreti textboxtan düş
            if (asi == 0) //Aşı yaptırmadığı sayı 0'sa
            {
                button2.Enabled = false; //Butona basama

            }
            if (asi < 1) //Aşı yaptırmadığı sayı 6'dan küçükse 
            {
                button1.Enabled = true; //Butona basabilsin
            }
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            textBox5.Text = saglikkont.ToString();
            textBox6.Text = saglikkontucret.ToString();
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            label11.Text = toplamislem.ToString(); //İşlemler labela yazdırılır,stringe çevrilir
        ...
        private void button14_Click(object sender, EventArgs e)
        {
            ...
            label14.Text = toplamekislem.ToString();
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            label15.Text = genelislem.ToString();
        }
